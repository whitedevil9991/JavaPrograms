public class StringClassDemo {
     ...
     */
     ...
     public static void main(String[] args) {
         ...
         //getChars() = saves the elements in the char
         ...
         String j2=j1.chars().distinct().mapToObj(c->String.valueOf);
         ...
         StringBuilder s12=new StringBuilder("this is string builder");
